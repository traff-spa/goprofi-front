...
import { UserOutlined, GoogleOutlined, MailOutlined, LockOutlined, EditOutlined } from '@ant-design/icons';
                ...
                {user.isEmailVerified ? (
                    <div className="profile__verification-tag verified">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 0C3.6 0 0 3.6 0 8C0 12.4 3.6 16 8 16C12.4 16 16 12.4 16 8C16 3.6 12.4 0 8 0ZM7 11.4L3.6 8L5 6.6L7 8.6L11 4.6L12.4 6L7 11.4Z" fill="#006654"/>
                      </svg>
                      Email Верифіковано
                    </div>
                ) : (
                    <div className="profile__verification-tag not-verified">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 0C3.6 0 0 3.6 0 8C0 12.4 3.6 16 8 16C12.4 16 16 12.4 16 8C16 3.6 12.4 0 8 0ZM12 10.4L10.4 12L8 9.6L5.6 12L4 10.4L6.4 8L4 5.6L5.6 4L8 6.4L10.4 4L12 5.6L9.6 8L12 10.4Z" fill="#F44"/>
                      </svg>
          ...
          <div className="profile__details">
            ...
            <div className="profile__details-group">
              <div className="profile__details-item">
                <div className="profile__details-item-label">ID користувача</div>
                <div className="profile__details-item-value">{user.id}</div>
              </div>
              <div className="profile__details-item">
            ...
            <div className="profile__details-group">
              <div className="profile__details-item" style={{ width: '100%' }}>
